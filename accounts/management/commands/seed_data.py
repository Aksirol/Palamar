...
ASSIGNMENT_TEMPLATES = {
    ...
    "Дискретна математика": [
        {"title": "Домашня робота №1: Теорія множин та відношень", "description": "Виконати операції над множинами, побудувати матрицю відношення та перевірити його властивості (рефлексивність, симетричність, транзитивність). 12 задач за варіантом."},
        {"title": "Домашня робота №2: Комбінаторика та ймовірність", "description": "Розрахувати кількість перестановок, розміщень та комбінацій для заданих умов. Застосувати формулу включень-виключень до 5 задач."},
        {"title": "Розрахункова робота: Теорія графів", "description": "Для заданого графу знайти: матрицю суміжності, компоненти зв'язності, ейлерів та гамільтонів шляхи (якщо існують), остовне дерево методом Краскала."},
    ],
    "Комп'ютерна архітектура": [
        {"title": "Лабораторна №1: Системи числення та кодування", "description": "Перевести числа між двійковою, вісімковою, шістнадцятковою та десятковою системами. Виконати арифметичні операції у двійковому доповненні. Закодувати символи у ASCII та Unicode."},
        {"title": "Лабораторна №2: Логічні схеми та автомати", "description": "Спростити булеву функцію методом Карно. Синтезувати комбінаційну схему для заданої таблиці істинності. Розробити скінченний автомат для простого протоколу."},
        {"title": "Реферат: Архітектура сучасного процесора", "description": "Підготувати реферат (10–12 сторінок) про архітектуру обраного процесора (Intel Core, AMD Ryzen або ARM). Описати мікроархітектуру, конвеєр, кеш-пам'ять та механізми передбачення переходів."},
    ],
    "Об'єктно-орієнтоване програмування": [
        {"title": "Лабораторна №1: Класи та об'єкти Java", "description": "Реалізувати клас із полями, конструкторами, методами та перевизначеними toString()/equals()/hashCode(). Продемонструвати інкапсуляцію через getter/setter та модифікатори доступу."},
        {"title": "Лабораторна №2: Спадкування та поліморфізм", "description": "Побудувати ієрархію класів (не менше 3 рівнів) для предметної галузі. Реалізувати абстрактні методи та інтерфейси. Продемонструвати динамічний поліморфізм через масив базових посилань."},
        {"title": "Курсова: Бібліотечна система на Java", "description": "Розробити консольну систему управління бібліотекою з класами Book, Reader, Librarian. Реалізувати пошук, видачу/повернення книг, серіалізацію даних у JSON-файл та модульні тести (JUnit)."},
    ],
    "Веб-технології": [
        {"title": "Практична №1: Верстка адаптивного лендінгу", "description": "Сверстати адаптивну сторінку-лендінг (desktop + mobile) за наданим макетом. Використати CSS Grid та Flexbox. Валідувати HTML/CSS через W3C Validator. Репозиторій на GitHub."},
        {"title": "Практична №2: JavaScript — інтерактивний UI", "description": "Реалізувати інтерактивний компонент (калькулятор, TODO-список або квіз) на чистому JavaScript (без фреймворків). Підключити локальне сховище (localStorage) для збереження стану."},
        {"title": "Проект: SPA на React або Vue.js", "description": "Розробити односторінковий застосунок (SPA) з отриманням даних із публічного API, роутингом та формами. Задеплоїти на GitHub Pages або Vercel. Здати посилання на демо та репозиторій."},
    ],
    "Кібербезпека": [
        {"title": "Лабораторна №1: Симетричне та асиметричне шифрування", "description": "Зашифрувати та розшифрувати тестове повідомлення за допомогою AES-256 та RSA-2048 (бібліотека OpenSSL або PyCryptodome). Порівняти швидкість та випадки застосування обох алгоритмів."},
        {"title": "Лабораторна №2: Аналіз мережевого трафіку", "description": "Перехопити та проаналізувати мережевий трафік за допомогою Wireshark у навчальному середовищі. Ідентифікувати протоколи, знайти аномалії та описати заходи захисту."},
        {"title": "Звіт: Аудит безпеки веб-застосунку", "description": "Провести базовий аудит безпеки навчального веб-застосунку (DVWA або WebGoat): виявити та описати вразливості OWASP Top-10 (XSS, SQLi, CSRF тощо), запропонувати виправлення."},
    ],
    "Ділова комунікація": [
        {"title": "Есе: Мій стиль ділового спілкування", "description": "Написати есе (500–700 слів) про власний комунікативний стиль, його сильні сторони та зони розвитку. Спертися на результати самодіагностики за опитувальником Томаса-Кілмана."},
        {"title": "Презентація: Публічний виступ", "description": "Підготувати та виголосити 7-хвилинну презентацію на обрану фахову тему. Використати принципи піраміди Барбари Мінто. Отримати зворотній зв'язок від аудиторії за чек-листом."},
        {"title": "Кейс: Переговори та вирішення конфлікту", "description": "Розробити сценарій ділових переговорів (ролі: замовник — виконавець) для вирішення запропонованого конфлікту. Розіграти ситуацію у парах та написати аналіз результату."},
    ],
    "Основи економіки": [
        {"title": "Домашня робота №1: Попит, пропозиція та рівновага", "description": "Побудувати криві попиту та пропозиції для заданого ринку. Знайти рівноважну ціну та обсяг. Проаналізувати вплив зміни доходу та ціни на рівновагу (5 задач за варіантом)."},
        {"title": "Домашня робота №2: Витрати та прибуток фірми", "description": "Розрахувати постійні, змінні та граничні витрати за даними таблиці. Визначити оптимальний обсяг виробництва та точку беззбитковості. Побудувати графіки TC, TR, Profit."},
        {"title": "Реферат: Економіка ІТ-галузі України", "description": "Підготувати реферат (12–15 сторінок) про стан та перспективи ІТ-ринку України. Включити статистику, аналіз ключових гравців (Epam, SoftServe, Luxoft тощо) та вплив зовнішніх чинників."},
    ],
    "DEFAULT": [
