    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, default='avatars/default.png', null=True, upload_to='avatars/', verbose_name='Фото профілю')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('academic_degree', models.CharField(blank=True, max_length=100, null=True, verbose_name='Вчений ступінь')),
            ],
        ),
        migrations.CreateModel(
            name='Student',
            fields=[
                ...
                ('group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='subjects.group', verbose_name='Група')),
            ],
        ),
    ]
